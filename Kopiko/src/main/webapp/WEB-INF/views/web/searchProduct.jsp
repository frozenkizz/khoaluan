		...
		<div class="row pt-4">
			...
			<div class="col-lg-9 search-content">
				<div class="search-message">
					<p>
						Kết quả tìm kiếm cho '${keyword}' : <span class="text-secondary">&nbsp;
							</span>
					</p>
				</div>
						...
						<c:forEach items="${listProduct}" var="product">
							<div class="col-6 col-lg-3 col-md-4 category-wrap">
								<div class="category-box">
									<img src="/uploads/images/${product.listProductImage[0].imageUrl}" alt="#" width="100%"
										class="img img-responsive">
									<p class="category-name">${product.productName}</p>
									<div
										class="card-text text-left font-weight-bold d-flex justify-content-center">
										<span class="product__price product__price-old">${product.getStringPrice()}</span>
										<span class="product__price product__price-new">${product.getStringSalePrice()}</span>
									</div>
									<a href="/product/${ product.productId }" class="btn  margin__btn-add-cart m-auto">Xem sản phẩm</a>
								</div>
							</div>
						</c:forEach>
					<!-- </form> -->
...
<%-- <script src="<c:url value='/template/web/js/searchProduct.js'/>"></script> --%>