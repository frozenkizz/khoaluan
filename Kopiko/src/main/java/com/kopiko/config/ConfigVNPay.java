...
public class ConfigVNPay {
	...
	public static String vnp_Returnurl = "http://localhost:8080/checkout/payment/result";
	public static String vnp_TmnCode = "BDI8T21P";
	public static String vnp_HashSecret = "HENPIYKAIZCGXUXHBTKUQWXOBHFJQCFP";
